...
@section('content')
    ...
    @if($featuredArticle)
        <section class="hero-section relative overflow-hidden animate-[fade-in_0.6s_ease-out]">
            ...
            <div class="container relative section animate-[slide-up_0.6s_ease-out]">
                <a href="{{ route('articles.show', $featuredArticle->slug) }}" class="block group">
                    <div class="grid grid-cols-1 lg:grid-cols-[1.2fr_1fr] gap-8 items-center">
                        ...
                        <!-- Content -->
                        <div class="space-y-5 text-white relative bg-darker p-8 rounded-[var(--radius-base)] backdrop-blur-sm border border-white/10">
                            ...
                            <p class="text-base lg:text-lg text-white/90 leading-relaxed font-medium">
                                {{ $featuredArticle->excerpt }}
                            </p>

                            <div class="flex items-center gap-3 pt-2">
                                <div class="inline-flex items-center gap-2 text-primary font-bold uppercase text-sm tracking-wider group-hover:gap-8 transition-all">
                                    {{ __('Read Full Story') }}
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2">
                        ...
                        <div class="mb-6" x-data="{
                            ...
                            <div class="flex items-center gap-2 mb-4 overflow-x-auto pb-2">
                                <button @click="changeFederation('all')"
                                        ...
                                        class="px-6 py-3 rounded-[var(--radius-base)] min-h-[44px] text-sm font-semibold whitespace-nowrap transition-colors disabled:opacity-50 disabled:cursor-not-allowed">
                                    {{ __('All') }}
                                </button>
                            ...
                            <div x-show="activeFederation === 'pdc'" class="flex items-center gap-2 mb-4 overflow-x-auto pb-2">
                                <button @click="activeTournament = 'all'"
                                        ...
                                        class="px-4 py-2 rounded-[var(--radius-base)] min-h-[36px] text-xs font-semibold whitespace-nowrap transition-colors">
                                    {{ __('All Tournaments') }}
                                </button>
                                @foreach($majorCompetitions as $competition)
                                    @if($competition->federation->slug === 'pdc')
                                        <a href="{{ route('competitions.show', $competition->slug) }}"
                                           class="px-4 py-2 rounded-[var(--radius-base)] min-h-[36px] text-xs font-semibold whitespace-nowrap transition-colors bg-card text-muted-foreground hover:bg-muted border border-border hover:border-primary">
                                            {{ $competition->name }}
                                        </a>
                                    @endif
                                @endforeach
                                <a href="{{ route('competitions.index') }}"
                                   class="px-4 py-2 rounded-[var(--radius-base)] min-h-[36px] text-xs font-semibold whitespace-nowrap transition-colors bg-primary/10 text-primary hover:bg-primary hover:text-primary-foreground border border-primary/30">
                                    {{ __('All Competitions') }} →
                                </a>
                            </div>
                    ...
                    @if($recentResults->count() > 0)
                        <section class="mt-8 bg-card rounded-[var(--radius-base)] border border-card-border p-8 shadow-sm">
                                        ...
                                        <div class="flex items-start gap-8">
                                            ...
                                            <div class="flex-1 min-w-0">
                                                ...
                                                <div class="flex items-center gap-2 mb-2">
                                                    ...
                                                    <p class="text-[11px] text-white/80 font-medium">{{ $event->venue }}</p>
                                                </div>
                                ...
                                @foreach($topRankings->take(10) as $ranking)
                                    <a href="{{ route('players.show', $ranking->player->slug) }}" class="flex items-center gap-3 py-3 px-3 hover:bg-white/5 border-l-2 border-transparent hover:border-accent transition-all group -mx-3">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <p class="text-[10px] text-white/80 font-semibold uppercase tracking-wider mt-0.5">{{ $ranking->player->nationality }}</p>
                                        </div>
            ...
            <div class="space-y-10">
                ...
                <div class="bg-card border border-card-border rounded-[var(--radius-base)] overflow-hidden shadow-md" x-data="{ activeComp: 'all' }">
                    <div class="bg-gradient-to-r from-primary/10 to-primary/5 p-6 border-b border-border">
                        <div class="flex items-center justify-between flex-wrap gap-8">
                            <div class="flex items-center gap-8">
                                <div class="w-16 h-16 bg-primary/20 rounded-[var(--radius-base)] flex items-center justify-center text-3xl"><span role="img" aria-label="{{ __('DartsArena logo - dart target') }}">🎯</span></div>
                                <div>
                            ...
                            <a href="{{ route('federations.show', 'pdc') }}" class="inline-flex items-center gap-2 px-4 py-2 bg-primary text-primary-foreground rounded-[var(--radius-base)] text-sm font-semibold hover:bg-primary-hover transition-colors">
                                {{ __('View Federation') }}
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                                </svg>
                    ...
                    <div class="p-6">
                        <div class="flex items-center gap-2 mb-6 overflow-x-auto pb-2">
                            <button @click="activeComp = 'all'"
                                    ...
                                    class="px-6 py-3 rounded-[var(--radius-base)] min-h-[44px] text-sm font-semibold whitespace-nowrap transition-colors">
                                {{ __('All') }}
                            </button>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            @foreach($majorCompetitions->where('federation.slug', 'pdc')->take(6) as $competition)
                                <a href="{{ route('competitions.show', $competition->slug) }}"
                                   class="bg-muted/50 border border-border rounded-[var(--radius-base)] p-4 hover:bg-muted hover:border-primary/50 transition-all group">
                                    <div class="flex items-start gap-3">
                                        <div class="w-12 h-12 bg-primary/10 rounded-[var(--radius-base)] flex items-center justify-center text-2xl flex-shrink-0"><span role="img" aria-label="Trophy">🏆</span></div>
                                        <div class="flex-1 min-w-0">
                ...
                <div class="bg-card border border-card-border rounded-[var(--radius-base)] overflow-hidden shadow-md" x-data="{ activeComp: 'all' }">
                    <div class="bg-gradient-to-r from-accent/10 to-accent/5 p-6 border-b border-border">
                        <div class="flex items-center justify-between flex-wrap gap-8">
                            <div class="flex items-center gap-8">
                                <div class="w-16 h-16 bg-accent/20 rounded-[var(--radius-base)] flex items-center justify-center text-3xl"><span role="img" aria-label="World">🌍</span></div>
                                <div>
                            ...
                            <a href="{{ route('federations.show', 'wdf') }}" class="inline-flex items-center gap-2 px-4 py-2 bg-accent text-accent-foreground rounded-[var(--radius-base)] text-sm font-semibold hover:bg-accent/90 transition-colors">
                                {{ __('View Federation') }}
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                                </svg>
                    ...
                    <div class="p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            @foreach($majorCompetitions->where('federation.slug', 'wdf')->take(6) as $competition)
                                <a href="{{ route('competitions.show', $competition->slug) }}"
                                   class="bg-muted/50 border border-border rounded-[var(--radius-base)] p-4 hover:bg-muted hover:border-accent/50 transition-all group">
                                    <div class="flex items-start gap-3">
                                        <div class="w-12 h-12 bg-accent/10 rounded-[var(--radius-base)] flex items-center justify-center text-2xl flex-shrink-0"><span role="img" aria-label="Trophy">🏆</span></div>
                                        <div class="flex-1 min-w-0">
                ...
                <div class="bg-card border border-card-border rounded-[var(--radius-base)] overflow-hidden shadow-md" x-data="{ activeComp: 'all' }">
                    <div class="bg-gradient-to-r from-info/10 to-info/5 p-6 border-b border-border">
                        <div class="flex items-center justify-between flex-wrap gap-8">
                            <div class="flex items-center gap-8">
                                <div class="w-16 h-16 bg-info/20 rounded-[var(--radius-base)] flex items-center justify-center text-3xl"><span role="img" aria-label="Events">🎪</span></div>
                                <div>
                            ...
                            <a href="{{ route('federations.show', 'bdo') }}" class="inline-flex items-center gap-2 px-4 py-2 bg-info text-info-foreground rounded-[var(--radius-base)] text-sm font-semibold hover:bg-info/90 transition-colors">
                                {{ __('View Federation') }}
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                                </svg>
                    ...
                    <div class="p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            @foreach($majorCompetitions->where('federation.slug', 'bdo')->take(6) as $competition)
                                <a href="{{ route('competitions.show', $competition->slug) }}"
                                   class="bg-muted/50 border border-border rounded-[var(--radius-base)] p-4 hover:bg-muted hover:border-info/50 transition-all group">
                                    <div class="flex items-start gap-3">
                                        <div class="w-12 h-12 bg-info/10 rounded-[var(--radius-base)] flex items-center justify-center text-2xl flex-shrink-0"><span role="img" aria-label="Trophy">🏆</span></div>
                                        <div class="flex-1 min-w-0">
                ...
                <div class="bg-card border border-card-border rounded-[var(--radius-base)] overflow-hidden shadow-md" x-data="{ activeComp: 'all' }">
                    <div class="bg-gradient-to-r from-warning/10 to-warning/5 p-6 border-b border-border">
                        <div class="flex items-center justify-between flex-wrap gap-8">
                            <div class="flex items-center gap-8">
                                <div class="w-16 h-16 bg-warning/20 rounded-[var(--radius-base)] flex items-center justify-center text-3xl"><span role="img" aria-label="Fast">⚡</span></div>
                                <div>
                            ...
                            <a href="{{ route('competitions.index') }}" class="inline-flex items-center gap-2 px-4 py-2 bg-warning text-warning-foreground rounded-[var(--radius-base)] text-sm font-semibold hover:bg-warning/90 transition-colors">
                                {{ __('View Series') }}
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                                </svg>
                    ...
                    <div class="p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            <div class="bg-muted/50 border border-border rounded-[var(--radius-base)] p-4 hover:bg-muted hover:border-warning/50 transition-all group">
                                <div class="flex items-start gap-3">
                                    <div class="w-12 h-12 bg-warning/10 rounded-[var(--radius-base)] flex items-center justify-center text-2xl flex-shrink-0"><span role="img" aria-label="Fast">⚡</span></div>
                                    <div class="flex-1 min-w-0">
                            ...
                            <div class="bg-muted/50 border border-border rounded-[var(--radius-base)] p-4 hover:bg-muted hover:border-warning/50 transition-all group">
                                <div class="flex items-start gap-3">
                                    <div class="w-12 h-12 bg-warning/10 rounded-[var(--radius-base)] flex items-center justify-center text-2xl flex-shrink-0">💻</div>
                                    <div class="flex-1 min-w-0">
                                        <h4 class="font-semibold text-foreground group-hover:text-warning transition-colors">
    ...
    <section class="bg-muted section">
        <div class="container">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-card border border-card-border rounded-[var(--radius-base)] overflow-hidden hover:shadow-xl hover:border-primary/50 transition-all group">
                    <div class="bg-gradient-to-br from-primary/20 to-primary/5 p-6 border-b border-border">
                        <div class="flex items-center justify-between mb-4">
                            <span class="inline-flex items-center px-3 py-1 bg-success/20 text-success border border-success/30 rounded-[var(--radius-base)] text-xs font-bold uppercase tracking-wide">
                    ...
                    <div class="p-6">
                        ...
                        <div class="bg-primary/5 rounded-[var(--radius-base)] p-3 border border-primary/20">
                ...
                <div class="bg-card border border-card-border rounded-[var(--radius-base)] overflow-hidden hover:shadow-xl hover:border-accent/50 transition-all group">
                    ...
                    <div class="p-6">
                        ...
                        <div class="bg-accent/5 rounded-[var(--radius-base)] p-3 border border-accent/20">
                            <div class="flex items-center justify-between">
                                <span class="text-xs font-semibold text-muted-foreground uppercase">{{ __('Confidence') }}</span>
                ...
                <div class="bg-card border border-card-border rounded-[var(--radius-base)] overflow-hidden hover:shadow-xl hover:border-info/50 transition-all group">
                    ...
                    <div class="p-6">
                        ...
                        <div class="bg-info/5 rounded-[var(--radius-base)] p-3 border border-info/20">
                            <div class="flex items-center justify-between">
                                <span class="text-xs font-semibold text-muted-foreground uppercase">{{ __('Confidence') }}</span>
            ...
            <div class="mt-10 mb-6 max-w-3xl mx-auto">
                <div class="bg-warning/10 border border-warning/30 rounded-[var(--radius-base)] p-4 text-center">
            ...
            <div class="text-center">
                <a href="{{ route('articles.index') }}" class="inline-flex items-center gap-2 bg-primary text-primary-foreground hover:bg-primary-hover rounded-[var(--radius-base)] px-8 py-3 text-sm font-semibold transition-colors">
    ...
    <section class="bg-gradient-to-r from-primary via-primary-dark to-primary relative overflow-hidden section-sm">
        ...
        <div class="container relative">
            <div class="max-w-3xl mx-auto text-center space-y-6">
                ...
                <div class="flex flex-wrap gap-8 justify-center pt-4">
                    <a href="{{ route('articles.index') }}" class="inline-flex items-center justify-center gap-2 bg-white text-primary hover:bg-white/90 rounded-[var(--radius-base)] px-8 py-3 text-sm font-semibold transition-all duration-200 shadow-sm">
                        {{ __('Explore News') }}
                    </a>
                    <a href="{{ route('guides.index') }}" class="inline-flex items-center justify-center gap-2 border-2 border-white text-white hover:bg-white hover:text-primary rounded-[var(--radius-base)] px-8 py-3 text-sm font-semibold transition-all duration-200">
                        {{ __('Learn More') }}
                    </a>
                </div>
            </div>
